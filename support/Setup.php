...
class Setup
{
    ...
    private const PACKAGE_EASYWECHAT            = 'w7corp/easywechat';
    ...
    private const MESSAGES = [
        'zh_CN' => [
            ...
            'easywechat_question'  => '安装微信SDK w7corp/easywechat',
        ...
        'zh_TW' => [
            ...
            'easywechat_question'  => '安裝微信SDK w7corp/easywechat',
            'template_question'    => '模板引擎',
            'template_none'        => '不安裝',
        ...
        'en' => [
            ...
            'easywechat_question'  => 'Install WeChat SDK w7corp/easywechat',
    ...
    private static function askComponents(IOInterface $io, callable $msg): array
    {
        ...
        // EasyWeChat (default: no)
        if (self::confirmMenu($io, $msg('easywechat_question'), false)) {
            $addPackage(self::PACKAGE_EASYWECHAT);
        }
